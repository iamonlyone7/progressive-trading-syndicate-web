export const MARQUEE_ITEMS = [
  'Financial Assessment','Working Capital Optimization','Trade Finance Solutions',
  'Debt Restructuring','Vendor Credit Facilitation','Cash Flow Management',
  'Growth Planning','Risk Controls','Supply Chain Funding','Business Turnaround'
];
...
export const PROCESS = [
  { num:'I', title:'Financial Assessment', desc:'Comprehensive audit of your financial position, cash flows, debt obligations, and operational structure. We map the full picture before prescribing anything.' },
  { num:'II', title:'Strategy Development', desc:'Customized turnaround strategy with clear priorities, timelines, and measurable milestones. Practical, actionable, and built around your business reality.' },
  { num:'III', title:'Implementation Support', desc:'Active hands-on support through execution — negotiating with creditors, facilitating capital, restructuring operations, and tracking progress against targets.' },
  { num:'IV', title:'Sustainable Growth', desc:'Once stability is achieved, we pivot to growth — new capital structures, market expansion, and financial controls that make the recovery permanent.' },
];

export const WHY_ITEMS = [
  { title:'Single-Window Access', desc:'Every financial solution you need, through one relationship. No coordination overhead, no fragmented advice.' },
  { title:'Industry-Focused Expertise', desc:"We speak your sector's language. Manufacturing, trading, services, exports — our solutions are context-aware, not generic." },
  { title:'Institutional Network', desc:'Direct relationships with banks, NBFCs, trade finance providers, and alternative capital sources — opening doors most advisors cannot.' },
  { title:'Confidential & Committed', desc:'Absolute discretion at every stage. Your financial situation is handled with professionalism and privacy.' },
  { title:'Aligned Incentives', desc:'Our success is measured by your outcomes, not billing hours. We are invested in your turnaround as deeply as you are.' },
];
